...
<body class="text-center">
    ...
    <div>
        ...
        <div class="text-end">
            <a href="{{ route('producto.create') }}" class="btn btn-success m-3">Agregar nuevo producto</a>
        </div>
                ...
                @foreach ($productos as $producto)
                    <tr>
                        ...
                        <td>
                            ...
                            <form class="d-inline" action="{{ route('producto.delete', ['id' => $producto->id]) }}"
                                method="post">
                                @csrf
            ...
            <tbody>
                @foreach ($invoices as $invoice)
                    <tr>
                        ...
                        <td>
                            <form class="d-inline" action="{{ route('invoice.show', ['invoice_id' => $invoice->id]) }}"
                                method="post">
                                @csrf
